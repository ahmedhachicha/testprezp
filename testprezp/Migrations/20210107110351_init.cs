...
namespace testprezp.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_ApplicationUserModel_received",
                        column: x => x.received,
                        principalTable: "ApplicationUserModel",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_ApplicationUserModel_sent",
                        column: x => x.sent,
                        principalTable: "ApplicationUserModel",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_received",
                table: "Requests",
                column: "received");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_sent",
                table: "Requests",
                column: "sent");
        }
